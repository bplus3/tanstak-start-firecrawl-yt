  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6 w-full">
        <div className="flex justify-start">
            <Link to="/dashboard/items" className={buttonVariants({
            variant: 'outline',
        })}>
            <ArrowLeft />
            Go Back
        ...
        <div className="space-y-3">
            ...
            <a href={data.url} target="_blank" className="text-primary hover:underline inline-flex items-center gap-1 text-sm">
                View Original
                        ...
                        <div className="flex-1">
                            ...
                            {completion || data.summary ? (
                                ...
                                <p className="text-muted-foreground italic">
                                    {data.content ? 'No summary yet. Generate one with ai': 'No content available to summarize'}
                                </p>
                            )}
                        </div>
